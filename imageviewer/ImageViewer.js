        ...
        me.dockedItems = [{
            ...
            items: [{
...

                {
                    ...
                    icon: 'resources/images/imageviewer/page_width.png',
                    listeners: {
                    ...
                    icon: 'resources/images/imageviewer/page_height.png',
                    listeners: {
                    ...
                    icon: 'resources/images/imageviewer/page_size.png',
                    listeners: {
                    ...
                    icon: 'resources/images/imageviewer/rotate_right.png',
                    listeners: {
                    ...
                    icon: 'resources/images/imageviewer/rotate_left.png',
                    listeners: {
...

                {
                    ...
                    icon: 'resources/images/imageviewer/protractor.png',
                    enableToggle: true,
                    listeners: {
